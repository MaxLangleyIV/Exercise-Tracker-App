 ...
 * Use the [CompletedExercisesFragment.newInstance] factory method to
...
class CompletedExercisesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CompletedExercisesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CompletedExercisesFragment().apply {
